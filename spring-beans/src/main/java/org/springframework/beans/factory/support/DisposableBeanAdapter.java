...
class DisposableBeanAdapter implements DisposableBean, Runnable, Serializable {
    ...
    /**
     * bean实例是否是实现DisposableBean接口. 如果是, 销毁bean实例时调用标准销毁方法
     */
    ...
    /**
     * bean实例没有实现DisposableBean接口, 销毁bean实例时定义调用者需执行的销毁方法名字
     */
    ...
    /**
     * 销毁bean实例前需要通知的DestructionAwareBeanPostProcessor集合, 用于在bean实例销毁前可以处理某些操作场景
     */
